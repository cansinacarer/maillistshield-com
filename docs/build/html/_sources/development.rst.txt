...
Dev Containers are a the recommended way to develop this project. You simply clone this repository and open it in VS Code. This will create containers with the following applications:
